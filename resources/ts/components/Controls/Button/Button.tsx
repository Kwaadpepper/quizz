...
export default class Button extends React.Component<IButtonProps, IButtonStates> {
    ...
    public render(): React.ReactElement {
        const { children, onClick, disableAnimation, disabled, style, classNames, theme, display } = this.props;
        ...
        const isLight: boolean = (theme ?? IButtonTheme.Dark) == IButtonTheme.Light;
        return (
            <button
                className={[
                    styles.button,
                    displayStyle,
                    anim ? styles.animButton : "",
