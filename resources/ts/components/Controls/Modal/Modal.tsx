...
export default class Modal extends React.Component<IModalProps, IModalStates> {
        ...
        if (this.props.showing) {
            ...
            return (
                <div
                    className={[
                        styles.modalGlobal,
                        anim ? styles.animGlobal : "",
                        isLight ? styles.globalLightBackground : "",
                        classNames?.calloutStyle,
                    ].join(" ")}
                ...
                >
                    <section
                        className={[
                            styles.modal,
                            anim ? styles.animModal : "",
                            isLight ? styles.modalLight : "",
                            classNames?.modalStyle,
                        ].join(" ")}
                        onMouseEnter={(e) => this.canCloseOnEmptyClick(e, false)}
                        onMouseLeave={(e) => this.canCloseOnEmptyClick(e, true)}
                    ...
                    >
                        {hasHeader ?? true ? (
                            <section className={styles.modalHeader} style={style?.modalHeaderStyle}>
                                {headerTitle != "" ? (
                                    <h1
                                        className={[styles.modalTitle, classNames?.modalTitleStyle].join(" ")}
                                ...
                                {hasClosingButton ?? true ? (
                                    <button
                                        className={[
                                            ...
                                            isLight ? styles.modalButtonLight : "",
                                            classNames?.modalCloseButtonStyle,
                                        ].join(" ")}
                                        type="button"
                                        onClick={close}
                        ...
                        {headerTitle != "" || (hasClosingButton ?? true) ? (
                            <hr
                                className={[
                                    ...
                                    isLight ? styles.separatorLight : "",
                                    classNames?.modalSeparatorStyle,
                                ].join(" ")}
                        ...
                        <section
                            className={[styles.modalBody, classNames?.modalBodyStyle].join(" ")}
                            style={style?.modalBodyStyle}
                        >
                            {children ?? ""}
                        </section>
                    </section>
    ...
    public canCloseOnEmptyClick(e: React.MouseEvent<HTMLElement>, can: boolean) {
        const a = this.props.hideOnEmptyClick ?? true;
