...
export default class ControlExemple extends React.Component<IControlExempleProps, IControlExempleStates> {
    constructor(props: IControlExempleProps) {
        super(props);
    ...
    public render(): React.ReactElement {
                    ...
                    return (
                        <>
                            <div className={styles.main}>
                                <h2>Basic Inputs</h2>
                                <div>
                                    <Link onClick={undefined} disabled={true}>
                                        CheckBox
                                    </Link>
                                    <Link onClick={undefined} disabled={true}>
                                        Toggle
        ...
        return (
            <div className={styles.myControlExempleComponent}>
                <aside className={styles.leftPanel}>left panel</aside>
                <main className={styles.controlDisplayList}>{subpage()}</main>
            </div>
        );
    }
