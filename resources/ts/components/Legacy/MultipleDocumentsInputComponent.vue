<template>
  <div :class="`container multiple-documents-input multiple-documents-input-${intId} p-0`">
    <!-- Main buttons -->
    <div class="row">
    ...
    >
      <div class="row w-100 mx-auto my-2">
        ...
        >
          <div class="modal-dialog modal-xl d-flex align-items-center h-100 my-0 py-4">
